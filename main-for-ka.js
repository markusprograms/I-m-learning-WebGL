...
var vertPosLocation = gl.getAttribLocation(program, 'vertPos')
...
function perspectiveMat(fov,aspect,zn,zf){
    ...
    var f=Math.tan(1.57079632679-fov*0.008726646),
    rangeInv=1/(zn-zf)
...
//var projectionMatrix=perspectiveMat(60,canvas.width/canvas.height,0.1,1000)
